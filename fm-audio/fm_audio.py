...
# Title: Fm Audio
# Generated: Mon Sep 14 21:04:58 2020
##################################################
...
class fm_audio(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Fm Audio")
...
def main(top_block_cls=fm_audio, options=None):
